    ...
    <footer className="bg-[#17161A] text-center lg:text-left mt-10 sm:mt-20 text-white">
      ...
      <div className=" mx-10 py-10 text-left">
        <div className="grid-1 grid gap-8 grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 max-sm:text-start">
          {/* <!-- TW Elements section --> */}
          <div className="">
            <h5 className="mb-4 md:flex items-center justify-center font-semibold uppercase md:justify-start">
              Helpful Links
            </h5>
            {/* <p className="mb-4">
              <a className="text-white dark:text-neutral-200"
          ...
          {/* <!-- Products section --> */}
          <div className="">
            <h5 className="mb-4 md:flex justify-center font-semibold uppercase md:justify-start">
              Explore
            </h5>
            {/* <p className="mb-4">
              <a className="text-white dark:text-neutral-200"
