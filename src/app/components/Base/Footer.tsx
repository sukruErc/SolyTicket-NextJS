...
export default function App() {
  return (
    <footer
      className="bg-[#17161A] text-center lg:text-left mt-10 sm:mt-20 text-white">
      {/* <div
      ...
      <div className=" mx-10 py-10 text-left">
        <div className="grid-1 grid gap-8 grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 max-sm:text-start">
          ...
          <div className="">
            <h5
              className="mb-4 md:flex items-center justify-center font-semibold uppercase md:justify-start">
              Helpful  Links
            </h5>
            <p className="mb-4">
              <a className="text-white dark:text-neutral-200"
              >Refunds and Exchanges</a>
            </p>
            <p className="mb-4">
              <a className="text-white dark:text-neutral-200"
              >Ticket Your Event</a>
          ...
          <div className="">
            <h5
              className="mb-4 md:flex justify-center font-semibold uppercase md:justify-start">
              Explore
            </h5>
            <p className="mb-4">
              <a className="text-white dark:text-neutral-200"
          ...
          <div className='grid lg:grid-cols-7'>
            <div className="md:col-start-3 col-span-5">
              ...
              <div className="relative">
                <input className='border-[1px] outline-none border-white rounded-l-lg px-5 py-3 pr-28 bg-transparent w-full' type="text" placeholder='Enter Your E-mail'/>
                <button className='border-none outline-none rounded-r-lg px-6 py-[17px] border-[1px] border-white bg-white text-black font-medium text-xs absolute top-0 right-[-5px]'>SUBSCRIBE</button>
              </div>
            </div>
          </div>
        ...
        <p className='font-normal text-base'>Copyright © 2024 Solyticket.  All rights reserved.</p>
      </div>
    </footer>
  );
}
