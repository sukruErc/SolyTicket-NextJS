                ...
                <div className="grid md:grid-cols-2 ">
                    <div className='p-10'>
                        ...
                        <div className='my-5'>
                            ...
                            <input className='mr-1' type="radio" id='card' value={"card"} name="fav_language" />
                            <label className='mr-4' htmlFor="card">Card</label>
                            <input className='mr-1' type="radio" id='bank' value={"bank"} name="fav_language" />
                            <label className='mr-4' htmlFor="bank">Bank</label>
                            <input className='mr-1' type="radio" id='transfer' value={"transfer"} name="fav_language" />
                            <label className='mr-4' htmlFor="transfer">Transfer</label>

                        </div>
                        <div className='my-5'>
                            <h6>Card Number</h6>
                            <input type="text" className='newInput' placeholder='1234  5678  9101  1121' />
                        </div>
                        ...
                        <div className='my-5 mb-7'>
                            ...
                            <label className='text-[#565656]' htmlFor="saveDetails">Save card details</label>
                        </div>
                    ...
                    <div className='p-10 bg-[#4E43F10D]'>
                        ...
                        <div className='my-5'>
                            <h6 className='mb-2 w-full md:w-[50%] '>2 for 1 Deal! Royal Canadian International Circus - Calgary</h6>
                            <div className='grid grid-cols-6 gap-4 borderBottom border-[#4E43F1] border-opacity-50 pb-5'>
                                <div className="col-start-1 col-auto text-[#4E43F1]">$49.80</div>
                        ...
                        <div className='my-5'>
                            <div className='flex items-baseline justify-between self-center gap-4 borderBottom border-opacity-50 pb-7'>
                                <div className="w-8/12"><input type="text" className='newInput border-[#4E43F1] border-opacity-50 bg-white' placeholder='Gift or discount code' /></div>
                                <div className="w-auto"><button className='BlueButton max-w-full p-[auto]'>Apply</button></div>
                            </div>
                        </div>
                        <div className='my-5'>
                        ...
                        <div className='my-5'>
                            <div className='flex justify-between self-center gap-4 pb-2 items-center'>
                                <div className='w-auto '>
                                    ...
                                    <div className='font-normal text-[14px] text-[#565656]'>Including $2.24 in taxes</div>
                                </div>
                                <div className='auto text-[32px] subHeadingtext'>
                                    $59.28
                                </div>
                            </div>
                        </div>
