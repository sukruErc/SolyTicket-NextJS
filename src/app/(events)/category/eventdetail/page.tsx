    ...
    return (
        <>
            <div className="container mx-auto px-5">
                <div className='my-16'>
                    <h2 className='font-bold text-[35px] md:text-[46px] w-full md:w-5/6 lg:w-4/6'>2 for 1 Deal! Royal Canadian International Circus - Calgary</h2>
                    ...
                    <div className="my-5">
                        <h5 className='font-bold mb-6'>Grief Webinar for the Loss or Death of a Pet</h5>
                        <p className='font-semibold'>
                            Welcome to the webinar "Grief for the Loss or Death of a Pet"! Have you lost your furry companion and are you feeling a great void in your heart? This online event is the perfect place to find support and understanding during difficult times. <br />
                            Join us as we explore together the emotions that arise when facing the loss of a pet. We will learn to manage grief in a healthy way and honor the legacy of our beloved furry friends. <br />
                            You are not alone in this process. Register now and join our online community to share experiences, tips and virtual hugs. Together we can heal and fondly remember those who have left their mark on our lives. <br />
                            We will wait for you! <br />
                            American Schnauzer <br />
                            Federiko Narváez - Coach, NLP, Speaker & Bachelor in Psychology</p>
                    </div>
                    <div className='mb-20'>
                        <h5 className='font-bold mb-6'>Organizer</h5>
                        <OrganizerDetail organizerName='Tahir' joined="Joined Since 2020" city="Lahore" />
                    </div>
                    <div>
